...
class Sf_test0ls : public SouffleProgram {
private:
...
// -- Table: typed
Own<t_btree_ii__0_1__11> rel_1_typed = mk<t_btree_ii__0_1__11>();
souffle::RelationWrapper<t_btree_ii__0_1__11> wrapper_rel_1_typed;
public:
Sf_test0ls()
: wrapper_rel_1_typed(0, *rel_1_typed, *this, "typed", std::array<const char *,2>{{"s:symbol","s:symbol"}}, std::array<const char *,2>{{"x","t"}}, 0)
{
addRelation("typed", wrapper_rel_1_typed, false, true);
}
~Sf_test0ls() {
}
...
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\tt"},{"auxArity","0"},{"name","typed"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"t\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"s:symbol\", \"s:symbol\"]}}"}});
if (!outputDirectoryArg.empty()) {directiveMap["output-dir"] = outputDirectoryArg;}
IOSystem::getInstance().getWriter(directiveMap, symTable, recordTable)->writeAll(*rel_1_typed);
...
rwOperation["name"] = "typed";
rwOperation["types"] = "{\"relation\": {\"arity\": 2, \"auxArity\": 0, \"types\": [\"s:symbol\", \"s:symbol\"]}}";
IOSystem::getInstance().getWriter(rwOperation, symTable, recordTable)->writeAll(*rel_1_typed);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
SouffleProgram *newInstance_test0ls(){return new Sf_test0ls;}
SymbolTable *getST_test0ls(SouffleProgram *p){return &reinterpret_cast<Sf_test0ls*>(p)->getSymbolTable();}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_test0ls: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_test0ls();
};
public:
factory_Sf_test0ls() : ProgramFactory("test0ls"){}
};
extern "C" {
factory_Sf_test0ls __factory_Sf_test0ls_instance;
}
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(test0.dl)",
R"()",
R"()",
false,
R"()",
