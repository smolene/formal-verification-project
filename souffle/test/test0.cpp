...
class Sf_test0 : public SouffleProgram {
private:
...
SouffleProgram *newInstance_test0(){return new Sf_test0;}
SymbolTable *getST_test0(SouffleProgram *p){return &reinterpret_cast<Sf_test0*>(p)->getSymbolTable();}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_test0: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_test0();
};
public:
factory_Sf_test0() : ProgramFactory("test0"){}
};
extern "C" {
factory_Sf_test0 __factory_Sf_test0_instance;
}
}
#else
}
